...
function CapacityMeter({ accountName, label, window, usageBlocked, quotaIsLastKnown }: { accountName: string; label: string; window: QuotaWindow; usageBlocked: boolean; quotaIsLastKnown: boolean }) {
  ...
  return <div className="capacity">
    <span><strong>{remaining}%</strong> {capacityLabel}</span>
